    ...
    setTimeout(() => {
      callback({
        ...
        changelog: [
          ...
          'Notebook Spine UI Tweaks & Touch Long-Press (v2.8.4): Notebook spine now inherits note theme background while base card retains clean surface elevation; dynamic pin state indicator; dedicated Star/Favorite section below pin; high-contrast theme-proof spine buttons; context menu popover fix for desktop & mobile; and 500ms touch long-press context menu gesture',
